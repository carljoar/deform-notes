...
\subsection[Appl. space of metrics]{Application to the space of metrics}
...
U(\varphi)= \frac{1}{2\sigma^2}\|I\circ \varphi^{-1}-I'\|^2_{L^2}.
\]
The space of metrics on $M$ is an open, convex, positive cone in the Fréchet space of all smooth, symmetric 2-forms.
...
\subsubsection*{Diffeomorphisms and metrics}
...
\newpage
\bibliographystyle{apalike} %{nar} %{alpha}
\bibliography{refs}
