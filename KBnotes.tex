...
Let us now consider the same results as the above, but with a slightly different problem:
\begin{equation}
\min\left\{\left(\lambda\|I\circ\varphi^{-1}-I'\|_{L^2}+d_\mathcal{H}(\varphi_*g,\id)\right) : g\in G_\mathcal{H} \right\}.
\end{equation}
